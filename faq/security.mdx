---
title: "Security & Risks"↵icon: "triangle-exclamation"
...
<CardGroup cols={2}>
  <Card title="Non-Custodial" icon="lock">
    Qubit Alpha never holds custody of your funds.
  </Card>
...
While Qubit Alpha uses audited contracts, no smart contract is 100% risk-free:
...
<Warning>
The information provided by Qubit Alpha is for educational purposes only and should not be considered financial advice. Always do your own research and consider consulting a financial advisor before investing.
</Warning>
