...
<Warning>
Each Sub Account must have its own dedicated API Key. One API Key cannot operate multiple Sub Accounts simultaneously due to Nonce mechanism limitations.
</Warning>
